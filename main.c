...
/**
 * free_vglo - this will free the global variables
 *
 * Return: no return
 */
void free_vglo(void)
...
/**
 * start_vglo - this initializes the global variables
 *
...
/**
 * check_input - this checks if the file exists and if the 
 * file can be opened
 *
 * @argc: for the argument count
 * @argv: for the argument vector
 * Return: to return the file struct
 */
 ...
 *
 * @argc: to rep the argument count
 * @argv: to rep the argument vector
