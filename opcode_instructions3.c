...
/**
 * _mul - this will multiply the top element to the second top element of the stack
 *
...
/**
 * _pchar - this print the char value of the first element
 *
...
/**
 * _pstr - this will prints the string of the stack
 *
